...
function EscalatedPage() {
  ...
  // Only evaluate access once the profile/role has actually loaded.
  useEffect(() => {
    if (!ready) return;
    if (!allowed) navigate({ to: "/admin", replace: true });
